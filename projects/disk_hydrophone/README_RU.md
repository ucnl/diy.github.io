[Главная](/README_RU) ❯ **Проект №1: Изготовление дискового гидрофона**
...
# Проект №1: Изготовление дискового гидрофона
...
Место, отмеченное кончиком пинцета, показывает докуда нужно зашкурить кабель. Зашкурить нужно будет перед установкой в форме, перед окончательным обезжириванием.
...
Как сделать предусилитель для вашего нового гидрофона мы расскажем в [следующей статье](/projects/preamplifier_for_hydrophone/README_RU.html).
