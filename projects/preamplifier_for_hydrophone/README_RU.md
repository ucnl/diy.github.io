...
После того, как тонер будет полностью удален процесс изготовления печатной платы можно считать полностью завершенным. Можно смело переходить к сборке!
...
| ![step](4.jpeg) |
| :---: |
| рисунок 30 - Нанесение флюса |

Устанавливаем элемент:

| ![step](3.jpeg) |
| :---: |
| рисунок 31 - Установка элемента |

Касаемся жалом паяльника нитки припоя и пропаиваем ножки элемента:

| ![step](2.jpeg) |
| :---: |
| рисунок 32 - Пропаивание элемента |
