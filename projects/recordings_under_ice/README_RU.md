...
## Дисклеймер
**ВНИМАНИЕ!!! Водоемы - повышенный источник опасности и присутствие на воде или на поверхности льда требует строжайшего соблюдения правил безопасности! 
...
Чтобы он выглядел так же, как и на скриншоте выше, выберите пункт меню **View** > **Waveform & Spectral View** или просто нажмите **Ctrl + 3**.
...
### [Фрагмент записи №3: Исходный сигнал](3_0_source_signal.wav)
