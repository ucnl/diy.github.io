...
# Проект №3: Корпуса для подводных устройств - Батарейный блок
...
Полипропилен относится к _благородным_ пластикам, которые толком ничем не склеиваются, не разлагаются и достаточно устойчивы к ультрофиолету и агрессивным средам, а разных фитигов под него есть столько, что у нас точно не возникнет сложности подобрать что-нибудь для своих подводных нужд.
...
| 7 | Кабель КГ 2х1.5 | ~1 м | |
| 8 | Термоусадка Ф25 мм | ~1 м | |
| 9 | Паяльный набор - припой и флюс | | |
| 10 | Фум лента или аналог | | |
| 11 | Никилевая полоса | ~1 м | В принципе, если аппарат точечной сварки не используется, может быть заменена проводом |
...
Итак, начинаем сборку снизу, привариаем (или припаеваем) никелевую полоску к "плюсу" нижнего элемента, оставлем небольшой промежуток и привариваем к этой полоске "минус" следующего элемента.
...
Припаиваем провода к плате, самый "нижний" к выводу платы "0 V", следующий к "3.7 V" и так далее. Выход и он же вход батареи - контактные площадки "P+" и "P-"

| ![image](https://github.com/user-attachments/assets/46c061c4-17e3-4956-9b66-656934ce54bf) |
| :---: |
| рисунок 7 - Все готово к упаковке в термоусадочкую трубку |
...
Очередность должна быть такая: сначала ввариваем заглушку с гермовводом, проталкиваем аккумулятор, убеждаемся, что аккумулятор не торчит из трубы, выпускаем провода через гермоввод и следом завариваем всю конструкцию второй заглушкой.

Для вставки гермоввода в заглушку, эту заглушку необходимо просверлить и нарезать резьбу (хотя бы номинально). Так как придется паять зуглушку с уже вставленным гермовводом, его нужно поставить максимально ровно по центру, иначе он может задевать нагревательный элемент сварочного аппарата. Поэтому удобнее всего сначала просверлить тонким сверлом заглушку изнутри, так как там проще определить центр. Дальше можно сверлить уже с внешней стороны, например, ступенчатым сверлом, диаметров на 1 мм меньше диаметра гермоввода. В моем случае резьба у гермоввода М16х1.5, это значит, что необходимо просверлить отверстие диаметром 15 мм.
Если у вас есть соответствующий метчик - вам повезло, а мы нерезали резьбу самим гермовводом, _аккуратно_ зажав последний в тиски. Главное не торопиться.

После того, как резъба будет готова, вкручиваем гермоввод на фум ленту или ее аналог. Комплектный О-ринг предварительно удаляем. Закручиваем до упора: чтобы гайка гермоввода касалась торца заглушки.

| ![image](https://github.com/user-attachments/assets/24510d32-24f8-4716-bec9-d0981215bfca) |
| :---: |
| рисунок 8 - Вкручиваем гермоввод на фум ленту. В конеце не должно оставаться зазора между гайкой гермоввода и торцом заглушки |

Ввариваем заглушку с гермовводом:

| ![image](https://github.com/user-attachments/assets/0621223b-61ca-451c-856d-be795a450396) |
| :---: |
| рисунок 9 - Ввариваем заглушку |





Далее отмечаем и отрезаем нужный кусок от трубы. Крайне рекомендую купить хорошие роликовые ножницы, потому что они дают практически идеально ровный срез, перпендикулярный оси трубы.

| ![image](https://github.com/user-attachments/assets/083966b0-81f8-415a-ae05-95b4d073a5ad) |
| :---: |
| рисунок Х - Резка трубы |
