...
Since there are three _information_ pins (**BIT 0**, **BIT 1**) and each can have two digital states, 8 different codes can be transmitted in total.
...
**A**: **The easiest way to use two pairs of receiver-transmitter is to connect both pairs pin to pin (pins 1,3,5).**
